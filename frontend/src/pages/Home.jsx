              ...
              return (
                <div key={event._id} className="event-card">
                  <div className="event-image">
                    <img src={eventImages[index % eventImages.length]} alt={event.eventName} />
                  </div>
                  <div className="event-info">
                    <h4>{event.eventName}</h4>
                    <p className="date-info"><strong>Date:</strong> {dateDisplay}</p>
              ...
              return (
                <div key={`placeholder-${index}`} className="event-card placeholder-card">
                  ...
                  <div className="event-info">
                    ...
                    <p className="description">Stay tuned for upcoming events and activities.</p>
                  </div>
                </div>
              );
            }
